...
from tmpd.solvers import (
    ...
    DPSSMLD,
    PiGDMVE, PiGDMVP, ReproducePiGDMVP,
    KGDMVE, KGDMVP,
    KGDMVEplus, KGDMVPplus)
...
def get_cs_sampler(config, sde, model, sampling_shape, inverse_scaler, y, H, observation_map, adjoint_observation_map, stack_samples=False):
    ...
    Args:
        ...
        model:
        sampling_shape: The shape of array, x. (num_samples,) + x_shape, where x_shape is the shape
        ...
        stack_samples: Bool. If `True`, return an array (num_steps, *sampling_shape), if `False`, return an array (*sampling_shape).
